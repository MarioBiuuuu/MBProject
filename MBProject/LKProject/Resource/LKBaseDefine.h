...
//背景色
#define DEF_VIEWCONTROLLER_BGCOLOR [UIColor colorWithWhite:0.961 alpha:1.000]
...
//获取商户信息模型
#define DEF_USER_MODEL [UserInfoModel getUserModel]
#define DEF_MERCHANT_MODEL [MerchantInfoModel getMerchantInfoModel]
#define DEF_STORE_MODEL [StoreInfoModel getStoreInfoModel]
//设置随机颜色
