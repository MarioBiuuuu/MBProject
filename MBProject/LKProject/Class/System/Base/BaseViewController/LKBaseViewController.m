...
#import "LKCommonLoadingAnimationView.h"
...
@property (nonatomic, weak) LKCommonLoadingAnimationView *animationView;
...
- (void)showLoadingAnimation {
    LKCommonLoadingAnimationView *animation = [[LKCommonLoadingAnimationView alloc] init];
...
- (LKCommonNoNetworkingView *)noNetworkEmptyView {
    if (!_noNetworkEmptyView) {
        LKCommonNoNetworkingView *empty = [[LKCommonNoNetworkingView alloc] initWithFrame:CGRectMake(0, 0, self.view.bounds.size.width, self.view.bounds.size.height)];
