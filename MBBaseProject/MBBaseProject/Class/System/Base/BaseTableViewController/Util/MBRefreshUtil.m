...
@interface MBChatRefreshHeader ()
@property (weak, nonatomic) UIActivityIndicatorView *loading;

@end

@implementation MBChatRefreshHeader
...
@implementation MBGifRefreshHeader
...
+ (void)addPullRefreshForScrollView:(UIScrollView *)scrollView
    ...
    if (isChat) {
        MBChatRefreshHeader *header = [MBChatRefreshHeader headerWithRefreshingBlock:^{
        ...
        switch (headerType) {
            case MBRefreshUtilHeaderRefreshTypeNormal: {
                ...
                break;
            case MBRefreshUtilHeaderRefreshTypeGif: {
                MBGifRefreshHeader *header = [MBGifRefreshHeader headerWithRefreshingBlock:^{
                    if (pullRefreshCallBackBlock) {
                        pullRefreshCallBackBlock();
                    }
                    if (weakScrollView.mj_footer.hidden == NO) {
