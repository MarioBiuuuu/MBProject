...
@interface MBCommonNoNetworkingView ()
...
@implementation MBCommonNoNetworkingView
...
- (void)layoutSubviews {
    ...
    CGFloat retryY = CGRectGetMaxY(self.topTipImageView.frame)  + 15;
    CGFloat retryW = 60;
    CGFloat retryH = 25;
