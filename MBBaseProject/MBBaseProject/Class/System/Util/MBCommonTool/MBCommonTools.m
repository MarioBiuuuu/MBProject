...
+ (NSString *)getInternetDate
{
    ...
    if (error) {
        return [MBCommonTools getCurrentDateString];
    }
 ...
 */
+ (NSString *)getDateWithDateFormatType:(NSString *)dateFormatType dateString:(NSString *)timeString
{
    NSTimeInterval interval=[timeString doubleValue] / 1000.0;
    NSDate *date = [NSDate dateWithTimeIntervalSince1970:interval];
    NSDateFormatter *objDateformat = [[NSDateFormatter alloc] init];
    objDateformat.timeZone = [NSTimeZone timeZoneWithAbbreviation:@"GMT+0800"];
    [objDateformat setDateFormat:dateFormatType];
